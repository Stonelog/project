...
class sql_api
{
	public:
		...
		static sql_api * sql_api_create(const std::string &_host = "127.0.0.1",const std::string &_user = "root",\
										const std::string &_passwd = "",const std::string & _db = "test", const int _port = 3306);
